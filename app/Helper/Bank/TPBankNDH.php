<?php
	...
	class TPBankNDH
	{
		...
		private $token = "eyJraWQiOiJNYmV1VmVVWlhVT2FJcDgwYmx1XC9sanFOQjNKZE9aSDgxQ3JGU0tpMmVcL2M9IiwiY3R5IjoiSldUIiwiZW5jIjoiQTEyOENCQy1IUzI1NiIsImFsZyI6ImRpciJ9..z7GQ1MXBSev8KJFhKIo0sw.cLDjrk7b_0Dww9QMnrMXhTBw7n2WKbP8bKKObcFp6vDaYVKPfCR_4uZwxDl0mT99_9MVBQYgDx_T2TwpAsgfi0drJnwwVbi10W6zAxE2XH6oVtJ4d6kYMbifXWjZvFYPUXE-DJcv05rzR7knHB87pWfblRxg9VYZwRREZ6__9aNOjSGUzzc9Yml76Sn691CpuV56UHX6jG3e4GCktnPqtlEjExHAB79j0N4NNPT7ryEtrCsn16wwE54cfxECx23xTF6nr-NDsSaNca42fB3HA4_Mw-1kZSCz3VMGy1IotCP2LsRrelJ9tjkL1Pr2xl8c6EV8t64biJJQjsGNg_tOn3uXhpr4AJjcaPUORPlWQhpJ21jhGsezCcKInyWROFP0Bczb1LUu19Ho_HsrBn5zm8OfYDLBFuM9uLNXo8hDPAjgfePSAloazONiB_7tlpt-Wk08wt_mk-WpQKnjNj7GUtjm-JSqVrHxHFc672kts3fYJrf6PG8Eie5uYs2mODP0.SPeUgq_V0IDLCHeTvm8ETw";
		...
		public function getHistories($toDate,$fromDate)
		{
			$params = array(
			  ...
			  "fromDate" => $fromDate,
			  "currency" => "VND",
			  "accountNo" => $this->debtorAccountNumber,
			  "keyword" => "",
			  "maxAcentrysrno"=> "",
			  "pageNumber"=> 1,
			  "pageSize"=> 400
			...
			$decodedData =json_decode($getHistories, true);
			...
			if(isset($decodedData) && $decodedData)
			{
				Telegram::sendMessage([
				  'chat_id' => "1281282845",
				  'parse_mode' => 'HTML',
				  'text' =>'TPBank Ha88 NDH dự liệu trả về là : '
				]);
			...
			Telegram::sendMessage([
			  'chat_id' => "1281282845",
			  'parse_mode' => 'HTML',
			  'text' =>'TPBank  Ha88 NDH: không có dữ liệu trả về '
			]);
