<?php
	...
	class HistoryViettelPayDataTable extends DataTable
	{
		/**
		...
		public function dataTable(QueryBuilder $query): EloquentDataTable
		{
			return (new EloquentDataTable($query))
				->editColumn('created_at', function (HistoryViettelPay $model) {
					return $model->created_at->format('d M, Y');
				})
				->editColumn('detail', function (HistoryViettelPay $model) {
					...
					return view('pages.historyviettelpay._details', compact('content'));
				})
				->addColumn('action', function (HistoryViettelPay $model) {
					return view('pages.historyviettelpay._actionmenu', compact('model'));
				});
		}
		 ...
		 *
		 * @param \App\Models\HistoryViettelPay $model
		 * @return \Illuminate\Database\Eloquent\Builder
		 */
		public function query(HistoryViettelPay $model): QueryBuilder
		{
		...
		{
			return $this->builder()
				->setTableId('historyviettelpay-table')
...
//				Column::make('updated_at'),
		...
		{
			return 'HistoryViettelPay_' . date('YmdHis');
		}
	}
