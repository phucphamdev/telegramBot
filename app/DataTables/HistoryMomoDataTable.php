<?php
	...
	class HistoryMomoDataTable extends DataTable
	{
		/**
		...
		public function dataTable(QueryBuilder $query): EloquentDataTable
		{
			return (new EloquentDataTable($query))
				->editColumn('created_at', function (HistoryMomo $model) {
					return $model->created_at->format('d M, Y');
				})
				->editColumn('detail', function (HistoryMomo $model) {
					...
					return view('pages.historymomo._details', compact('content'));
				})
				->addColumn('action', function (HistoryMomo $model) {
					return view('pages.historymomo._actionmenu', compact('model'));
				});
		}
		 ...
		 *
		 * @param \App\Models\HistoryMomo $model
		 * @return \Illuminate\Database\Eloquent\Builder
		 */
		public function query(HistoryMomo $model): QueryBuilder
		{
...
//				Column::make('updated_at'),
		...
		{
			return 'HistoryMomo_' . date('YmdHis');
		}
	}
