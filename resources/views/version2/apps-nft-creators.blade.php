...
@section('content')
                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="ms-3 flex-grow-1">
                            ...
                            <p class="text-muted fs-14 fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i>
                                4,754 ETH</p>
                        </div>
                        <div>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-03.jpg')}}" alt="" class="object-cover card-img-top"
                     height="120">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-05.jpg')}}" alt="" class="object-cover card-img-top"
                     height="120">
                <div class="card-body text-center">
                    <img src="{{URL::asset('assets/images/nft/img-06.jpg')}}" alt=""
                         class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-06.jpg')}}" alt="" class="object-cover card-img-top"
                     height="120">
                <div class="card-body text-center">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-01.jpg')}}" alt="" class="object-cover card-img-top"
                     height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                         class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
