        ...
        <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--end row-->
                    <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                    <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Music <span class="badge badge-soft-primary">679</span></a>
                    </h5>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--end row-->
                    <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                    <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Games <span class="badge badge-soft-primary">341</span></a>
                    </h5>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--end row-->
                    <a href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
                    <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Videos <span class="badge badge-soft-primary">1674</span></a>
                    </h5>
                </div>
            </div>
        </div>
