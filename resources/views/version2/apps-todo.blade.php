    ...
    <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
        <div class="file-manager-sidebar border">
            <div class="p-4 d-flex flex-column h-100">
                <div class="mb-3">
                    <button class="btn btn-primary w-100" data-bs-target="#createProjectModal" data-bs-toggle="modal"><i
                        ...
                        <li>
                            ...
                            <div class="collapse show" id="velzonAdmin">
                                <ul class="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                    ...
                                    <li>
                                        <a href="#!"><i class="ri-stop-mini-fill align-middle fs-15 text-secondary"></i>
                                            v1.5.0</a>
                                    </li>
                                    <li>
