        ...
        <div class="col-xxl-9">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="flexshrink-0">
                    <button class="btn btn-primary btn-sm"><i class="ri-star-line align-bottom"></i> Add Watchlist
                    </button>
                </div>
            </div>
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="{{URL::asset('/apps-crypto-transactions')}}" class="btn btn-soft-primary w-100">View
                            All Transactions <i
