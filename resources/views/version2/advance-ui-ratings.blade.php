                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <pre><code
                                                class="language-markup">&lt;div id="basic-rater" dir="ltr">&lt;/div></code></pre>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <pre><code
                                                class="language-markup">&lt;div id="rater-step" dir="ltr">&lt;/div></code></pre>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div dir="ltr">
                                            ...
                                            <button id="raterreset-button"
                                                    class="btn btn-light btn-sm ms-2">Reset
                                            </button>
                                        </div>
                                    </td>
                                    <td>
