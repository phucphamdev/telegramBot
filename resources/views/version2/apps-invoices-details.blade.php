                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    ...
                                    <h6><span class="text-muted fw-normal">Email:</span><span id="email">velzon@themesbrand.com</span>
                                    </h6>
                                    <h6><span class="text-muted fw-normal">Website:</span> <a
                                            href="https://themesbrand.com/" target="_blank" class="link-primary"
                    ...
                    <div class="col-lg-12">
                        <div class="card-body p-4">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-muted mb-1">Payment Method: <span class="fw-medium" id="payment-method">Mastercard</span>
                                </p>
