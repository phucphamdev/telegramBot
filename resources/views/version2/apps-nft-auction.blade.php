                    ...
                    <div class="d-lg-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 mt-4 mt-lg-0">
                            <ul class="nav nav-pills filter-btns" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fw-medium" type="button" data-filter="upto-15">Up to 15%
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fw-medium" type="button" data-filter="upto-30">Up to 30%
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fw-medium" type="button" data-filter="upto-40">Up to 40%
                                    </button>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Abstract Face
                                    Painting</a></h6>
                            <div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Patterns Arts &
                                    Culture</a></h6>
                            <div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Creative Filtered
                                    Portrait</a></h6>
                            <div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Smillevers
                                    Crypto</a></h6>
                            <div>
                    ...
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                47.12k </p>
                            <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Long-tailed
                                    Macaque</a></h6>
                            <div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                            </h6>
                            <div>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Robotic Body
                                    Art</a></h6>
                            <div>
                    ...
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                94.1k </p>
                            <h5 class="text-primary"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                            <h6 class="fs-15 mb-3"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a>
                            </h6>
                            <div>
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless align-middle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-soft-success btn-sm">Unfllow</button>
                                </td>
                            </tr>
                            <tr>
                                <td>
