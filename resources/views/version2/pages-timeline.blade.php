                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-muted mb-2">Wish someone a sincere ‘good luck in your new job’ with
                                        these sweet messages. Make sure you pick out a good luck new job card to go with
                                        the words, and pop a beautiful bunch of flowers from our gift range in your
                                        basket, to make them feel super special.</p>
                                    ...
                                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden ms-2">
                                            <h6 class="text-truncate mb-0"><a href="javascript:void(0);"
                                                                              class="stretched-link">Business Template -
                                                    UI/UX design</a></h6>
                                            <small>685 KB</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                                        ...
                                        <div class="flex-grow-1 ms-2 overflow-hidden">
                                            <h6 class="mb-0 text-truncate"><a href="javascript:void(0);"
                                                                              class="stretched-link">Bank Management
                                                    System - PSD</a></h6>
                                            <small>8.78 MB</small>
                                        </div>
                                    </div>
                    ...
                    <div class="timeline-item right">
                        ...
                        <div class="content shadow-none">
                            ...
                            <p class="text-muted fst-italic mb-2">" This is an awesome admin dashboard template. It is
                                ...
                                templates using boostrap 5.1.3 so far). I integrated it into a Rails 6 project. Needs
                    ...
                    <div class="timeline-item right">
                        ...
                        <div class="content shadow-none">
                            ...
                            <p class="text-muted mb-2">
                                It is important for us that we receive email notifications when a ticket is created as
                                our IT staff are mobile and will not always be looking at the dashboard for new tickets.
                            </p>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-0">It makes a statement, it’s impressive graphic
                                                    ...
                                                    situation and try, try again until it looks right, and each letter
                                ...
                                <div class="timeline-box">
                                    <div class="timeline-text">
                                        ...
                                        <p class="text-muted">In the trip planner, keep only one or two activities in a
                                            day if the purpose of the trip is to relax and take it easy during the
                                            vacation :</p>
                                        <div class="row border border-dashed rounded gx-2 p-2">
                                            <div class="col-3">
                                ...
                                <div class="timeline-box">
                                    <div class="timeline-text">
                                        ...
                                        <p class="text-muted mb-0">A client meeting, meaning, direct collaboration and
                                            communication with a customer, is the best way to understand their needs and
                                            how you can help support them.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
