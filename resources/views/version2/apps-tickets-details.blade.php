                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="hstack gap-3 flex-wrap">
                                            ...
                                            <div class="vr"></div>
                                            <div class="text-muted">Due Date : <span class="fw-medium" id="due-date">29 Dec, 2021</span>
                                            </div>
                                            <div class="vr"></div>
                                            <div class="badge rounded-pill bg-primary fs-12" id="ticket-status">New
                                            </div>
                                            <div class="badge rounded-pill bg-success fs-12" id="ticket-priority">High
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted">It would also help to know what the errors are - it could be something simple
                        ...
                        templates. Too much or too little spacing, as in the example below, can make things unpleasant
                        for the reader. The goal is to make your text as comfortable to read as possible. On the note of
                        consistency, color consistency is a MUST. If you’re not trying to create crazy contrast in your
                        design, then a great idea would be for you to use a color palette throughout your entire design.
                        It will subconsciously interest viewers and also is very pleasing to look at. <a
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center border border-dashed p-2 rounded">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Velzon-admin.zip</a>
                            </h6>
                    ...
                    <div class="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1"><a href="javascript:void(0);" class="link-secondary">Velzon-admin.ppt</a>
                            </h6>
