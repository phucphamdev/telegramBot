            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use<code> slide</code> class to set carousel with slides. Note the presence of
                        the <code>d-block</code> and <code>w-100</code> class on carousel images to prevent browser
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>You've probably heard that opposites attract. The same is true for fonts.
                                            Don't be afraid to combine font styles that are different but
                                            complementary.</p>
                                    </div>
                                </div>
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>Consistency piques people’s interest is that it has become more and more
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption text-white-50">
                                        ...
                                        <p>Increase or decrease the letter spacing depending on the situation and try,
                                            try again until it looks right, and each letter.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Carousels support swiping left/right on touchscreen devices to move between
                        slides.
                        This can be disabled using the <code>data-bs-touch</code> attribute. The example below also does
                        not include the
