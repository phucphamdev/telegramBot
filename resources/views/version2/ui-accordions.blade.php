                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        simply find a plan size that allows you to have this allotment, plus some extra
                                        for growth. Don't worry, there are no mistakes to be made here. You can always
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        original paid sign up date. Upgrading in the middle of your billing period will
                                        not change the billing date. Upgrading does however force an immediate,
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        plan at a later date, your bill will renew based on the date you had upgraded to
                                        a paid plan. All invoices are able to be viewed under your plan options in your
                                        SlickText account.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accor_withouticoncollapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        have the opportunity to be creative and make your own style choices. For that
                                        very reason, I went on a quest and spoke to many different professional graphic
                                        designers.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accor_plusExamplecollapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        nostrud organic, assumenda labore aesthetic magna elements, buttons, everything.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="accor_plusExamplecollapse2" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        right, and each letter has the perfect spot of its own. commodo enim craft beer
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accor_nestingExamplecollapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        online, a subscriber may submit to have their mobile number to receive marketing
                                        messages. The API will pass this information from said software over to
                                        Slicktext via API integration.
                                        <div
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accor_nestingExamplecollapse2" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        with contact-specific information when a text message is sent. These merge tags
                                        may also be known as personalization fields.
                                        <div
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accor_nestingExamplecollapse3" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        birthday messages. However, we will continue to deliver your auto-reply messages
                                        to allow your subscriber list to continue to grow.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="accordion custom-accordionwithicon accordion-fill-primary"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="accor_fill2" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                Head over to the Textwords page. Click options on the right hand side,
                                                and then click Settings. This will redirect you to your Textword Setting
                                                page. Now, go check your url, and the textword ID will be the number
                                                after "word=". Too much or too little spacing, as in the example below.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        ...
                        attribute. In both cases, the <code>data-bs-toggle="collapse"</code> is required.
                    </p>
                    <div class="live-preview">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        ...
                        referencing them with a selector in its href or data-bs-target attribute. Multiple <code>&lt;button&gt;</code>
                        or <code>&lt;a&gt;</code> can
