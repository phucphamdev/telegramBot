                        ...
                        <div class="tab-pane active" id="all" role="tabpanel">
                            ...
                            <div class="py-3">
                                ...
                                <ul class="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                    ...
                                    <li class="list-inline-item me-3"><i
                                            class="ri-question-answer-line align-middle me-1"></i>43
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                            ...
                            <div class="py-3">
                                ...
                                <ul class="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                    <li class="list-inline-item me-3"><i
                                            class="ri-thumb-up-line align-middle me-1"></i>102
                                    </li>
                                    <li class="list-inline-item me-3"><i
                                            class="ri-question-answer-line align-middle me-1"></i>36
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            ...
                                            <div class="box-content">
                                                <div class="d-flex align-items-center mt-2">
                                                    <div class="flex-grow-1 text-muted">by <a href=""
                                                                                              class="text-body text-truncate">Elwood
                                                            Arter</a></div>
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex gap-3">
                                                            <button type="button"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            ...
                                            <div class="box-content">
                                                <div class="d-flex align-items-center mt-2">
                                                    <div class="flex-grow-1 text-muted">by <a href=""
                                                                                              class="text-body text-truncate">Jason
                                                            McQuaid</a></div>
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex gap-3">
                                                            <button type="button"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            ...
                                            <div class="box-content">
                                                <div class="d-flex align-items-center mt-2">
                                                    <div class="flex-grow-1 text-muted">by <a href=""
                                                                                              class="text-body text-truncate">James
                                                            Ballard</a></div>
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex gap-3">
                                                            <button type="button"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            ...
                                            <div class="box-content">
                                                <div class="d-flex align-items-center mt-2">
                                                    <div class="flex-grow-1 text-muted">by <a href=""
                                                                                              class="text-body text-truncate">Ruby
                                                            Griffin</a></div>
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex gap-3">
                                                            <button type="button"
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge badge-soft-success fs-11">Business</span>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5><a href="javascript:void(0);">How to become a best sale marketer
                                                            in
                                                            a year!</a></h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge badge-soft-primary fs-11">Product</span>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5><a href="javascript:void(0);">Stack designer Olivia Murphy
                                                            offers
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5><a href="javascript:void(0);">Design your apps in your own
                                                            way</a>
                                                    </h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    ...
                                                    <h5><a href="javascript:void(0);">How apps is changing the IT
                                                            world</a>
                                                    </h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item"><i
                                    ...
                                    <div class="list-element">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                                                <p class="text-muted mb-0">Velzon admin is super flexible, powerful,
                                                    clean,
                                                    modern & responsive admin template based on <b>bootstrap 5</b>
                                                    stable
                                                    ...
                                                    large projects or update design in your existing project using
                                                    Velzon it
