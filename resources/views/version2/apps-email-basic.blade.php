                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    as I've had an accident and hurt my back. I'm afraid I also need to
                                                    ask for an extension for next week's essay.
                                                </td>
                                            </tr>
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    listen to them at home. I will try to catch up with all the reading
                                                    too. However, I don't think I can submit the essay next week. Is it
                                                ...
                                                <td class="content-block"
                                                    ...
                                                    <div style="display: flex; align-items: center;">
                                                        <img src="{{URL::asset('assets/images/users/avatar-3.jpg')}}"
                                                             alt="" height="35" width="35" style="border-radius: 50px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    valign="top">
                                                    Since yesterday, I've been receiving thousands of emails, asking me
                        ...
                        <div class="content"
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    <p style="margin-bottom: 13px; line-height: 1.5;">You can change
                                                        your password for security reasons or reset it if you forget it.
                                                        Your Google Account password is used to access many Google
                                                        products, like Gmail and YouTube.</p>
                                                </td>
                                            </tr>
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block" itemprop="handler" itemscope
                            ...
                            <div style="text-align: center; margin: 28px auto 0px auto;">
                                ...
                                <p style="color: #878a99;">Please send and feedback or bug info to <a href=""
                                                                                                      style="font-weight: 500px;">info@velzon.com</a>
                                </p>
                                <p style="font-family: 'Roboto', sans-serif; font-size: 14px;color: #98a6ad; margin: 0px;">
                                    2022 Velzon. Design & Develop by Themesbrand</p>
                            </div>
