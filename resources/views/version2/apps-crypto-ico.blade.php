        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-xxl-1 col-lg-4">
                    <button class="btn btn-primary w-100"><i class="ri-equalizer-line align-bottom me-1"></i> Filters
                    </button>
                </div>
            </div><!--end row-->
        </div>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        ...
                        <div>
                            <a href="javascript:void(0);" class="badge badge-soft-secondary">Visit Website <i
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-success mb-0"><i class="ri-time-line align-bottom"></i> 05 Days
                        </h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-success mb-0"><i class="ri-time-line align-bottom"></i> 15 Days
                        </h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 25 Jan,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 04 Feb,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 05 March,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
            ...
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 15 Jan,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    ...
                    <h6 class="text-muted mb-0">$1,50,00,000 / $1,11,65,368 <span class="badge badge-soft-success">86.61%</span>
                    </h6>
                </div>
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 16 Feb,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 23 Jan,
                            2022</h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 30 Dec,
                            2021</h6>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card ribbon-box ribbon-fill right">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-primary mb-0"><i class="ri-time-line align-bottom"></i> 02 Dec,
                            2021</h6>
                    </div>
                </div>
            </div><!--end card-->
