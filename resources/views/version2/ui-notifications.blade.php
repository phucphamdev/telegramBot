                    ...
                    <div class="live-preview">
                        ...
                        <div class="position-relative">
                            <div class="hstack flex-wrap gap-2">
                                <button type="button" class="btn btn-primary" id="borderedToast1Btn">Primary Toast
                                </button>
                                <button type="button" class="btn btn-success" id="borderedToast2Btn">Success Toast
                                </button>
                                <button type="button" class="btn btn-info" id="borderedTost3Btn">Warning Toast</button>
                                <button type="button" class="btn btn-danger" id="borderedToast4Btn">Danger Toast
                                </button>
                            </div>
                            ...
                            <div style="z-index: 11">
                                <div id="borderedTost3" class="toast toast-border-info overflow-hidden mt-3"
                                     role="alert"
                    ...
                    <div class="live-preview">
                        <div class="hstack flex-wrap gap-2">
                            <button type="button" data-toast
                                    ...
                                    class="btn btn-light w-xs ">Default
                            </button>
                            <button type="button" data-toast data-toast-text="Your application was successfully sent"
                                    ...
                                    data-toast-duration="3000" class="btn btn-light w-xs">Success
                            </button>
                            <button type="button" data-toast data-toast-text="Warning ! Something went wrong try again"
                                    ...
                                    data-toast-duration="3000" class="btn btn-light w-xs">Warning
                            </button>
                            <button type="button" data-toast data-toast-text="Error ! An error occurred."
                                    ...
                                    data-toast-duration="3000" class="btn btn-light w-xs">Error
                            </button>
                        </div>
                        <div class="mt-4 pt-2">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <button type="button" data-toast
                                                ...
                                                data-toast-duration="3000"
                                                data-toast-offset data-toast-close="close" class="btn btn-light w-xs">
                                            Click
                                            Me
                                        </button>
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <button type="button" data-toast
                                                ...
                                                class="btn btn-light w-xs">Click Me
                                        </button>
                                    </div>
                                </div>
                            </div>
