            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="hstack gap-2 justify-content-center">
                        ...
                        <button class="btn btn-soft-secondary btn-sm"><i
                ...
                <div class="card-body">
                    <div class="text-muted">
                        ...
                        <p>It will be as simple as occidental in fact, it will be Occidental. To an English person, it
                            will
                            seem like simplified English, as a skeptical Cambridge friend of mine told me what
                            Occidental
                            is. The European languages are members of the same family. Their separate existence is a
                            myth.
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Joseph Parker</a>
                                            <small
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Thomas Taylor</a>
                                            <small
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-13"><a href="{{URL::asset('/pages-profile')}}">Nancy
                                                        Martino</a>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    <h6 class="fs-15 mb-0"><a href="javascript:void(0)"
                                                                              class="link-secondary">App pages.zip</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3 flex-grow-1">
                                                    <h6 class="fs-15 mb-0"><a href="javascript:void(0);"
                                                                              class="link-secondary">Bg-pattern.png</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <a href="{{URL::asset('/pages-profile')}}"
                                                       class="fw-medium link-secondary">Tonya
                                                        Noble</a>
                                                </div>
                                            </div>
                                        </td>
