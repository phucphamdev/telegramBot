                ...
                <div class="mt-auto">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 overflow-hidden">
                            ...
                            <span
                                class="text-muted fs-12 d-block text-truncate"><b>47.52</b>GB used of <b>119</b>GB</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-auto">
                            <div class="d-flex gap-2 align-items-start">
                                ...
                                <button class="btn btn-primary w-sm create-folder-modal flex-shrink-0"
                                        ...
                                        class="ri-add-line align-bottom me-1"></i> Create Folders
                                </button>
                            </div>
                        </div>
                        <!--end col-->
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item view-item-btn" href="javascript:void(0);">Open</a>
                                                </li>
            ...
            <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
                <div id="folder-overview">
                    ...
                    <div id="simple_dount_chart"
                         data-colors='["--vz-info", "--vz-warning", "--vz-primary", "--vz-success"]'
                    ...
                    <div class="pb-3 mt-auto">
                        <div class="alert alert-success d-flex align-items-center mb-0">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <button class="btn btn-sm btn-success"><i class="ri-upload-cloud-line align-bottom"></i>
                                    Upgrade Now
                                </button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn w-sm btn-danger" id="remove-folderList">Yes, Delete It!
                        </button>
                    </div>
                </div>
            </div><!-- /.modal-content -->
