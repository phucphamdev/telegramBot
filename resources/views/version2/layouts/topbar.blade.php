            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header"> Xin Chào {{ Auth::user()->first_name() }}</h6>
                        <a class="dropdown-item" href="{{ route('kpaypro.profile') }}"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Profile</span></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('kpaypro.profile') }}"><i
                                class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Số Dư : <b>{{ number_format( Auth::user()->so_du, 0, '', ',') }}  VNĐ</b></span></a>
                        <a class="dropdown-item" href="{{ route('kpaypro.settings') }}"><span
