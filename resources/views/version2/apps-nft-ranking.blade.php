                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/img-01.jpg')}}" alt=""
                                            ...
                                            href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/img-02.jpg')}}" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Creative Filtered
                                            Portrait</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/img-04.jpg')}}" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Robotic Body Art</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/img-06.jpg')}}" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-5.gif" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                                    </div>
                                </td>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Walking On Air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('assets/images/nft/img-04.jpg')}}" alt=""
                                             class="avatar-xs rounded-circle object-cover me-2"> <a
                                            href="apps-nft-item-details" class="link-dark">Highstreet IHO Part</a>
                                    </div>
                                </td>
