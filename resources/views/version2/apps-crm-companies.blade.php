                        ...
                        <div class="flex-shrink-0">
                            <div class="hstack text-nowrap gap-2">
                                ...
                                <button type="button" id="dropdownMenuLink1" data-bs-toggle="dropdown"
                                        aria-expanded="false" class="btn btn-soft-danger"><i class="ri-more-2-fill"></i>
                                </button>
                                ...
                                <form class="tablelist-form" autocomplete="off">
                                                    ...
                                                    <div class="position-relative d-inline-block">
                                                        ...
                                                        <div class="avatar-lg p-1">
                                                            <div class="avatar-title bg-light rounded-circle">
                                                                <img
                                                                    src="{{ URL::asset('assets/images/users/multi-user.jpg') }}"
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add Company
                                            </button>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            id="deleteRecord-close" aria-label="Close" id="btn-close"></button>
                                </div>
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <p class="text-muted fs-14 mb-4 pt-1">Deleting your company will remove all of
