            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a
                        navigation list based on the current scroll position. Scroll the area below the navbar and watch
                        the
                        active class
                        change.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with
                        nested nav. If a nested nav is active, its parents will also be active. Scroll the area next to
                        the
                                ...
                                <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0"
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <p>Ex consequat commodo adipisicing exercitation aute excepteur occaecat ullamco
                                            ...
                                            consectetur in. Aliqua et aliqua officia quis et incididunt voluptate non
                                            anim
                                            reprehenderit adipisicing dolore ut consequat deserunt mollit dolore.
                                            Aliquip
                                            nulla enim veniam non fugiat id cupidatat nulla elit cupidatat commodo velit
                                            ut
                                        ...
                                        <p>Quis magna Lorem anim amet ipsum do mollit sit cillum voluptate ex nulla
                                            ...
                                            deserunt sit enim elit aliqua esse irure. Laborum nisi sit est tempor
                                            laborum
