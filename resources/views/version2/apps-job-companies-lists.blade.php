            ...
            <div class="card" id="company-overview">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4 overview-companydesc">The IT department of a company ensures that the
                        network of computers within the organisation are well-connected and functioning properly. All
                        the other departments within the company rely on them to ensure that their respective functions
                        can go on seamlessly.</p>
                    ...
                    <div class="hstack gap-3">
                        ...
                        <a href="#!" class="btn btn-info w-100">More View <i
