                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    ...
                                    <h5>Metamask</h5>
                                    <p class="text-muted fs-14 pb-1">MetaMask is a popular cryptocurrency wallet known
                                        for its ease of use, availability on both desktops.</p>
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    ...
                                    <p class="text-muted fs-14 pb-1">Coinbase Wallet is a self-custody wallet that gives
                                        you complete control of your crypto for your Wallet.</p>
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{URL::asset('assets/images/nft/wallet/binance.png')}}" alt="" height="55"
                                         class="mb-3 pb-2">
                                    <h5>Binance</h5>
                                    <p class="text-muted fs-14 pb-1">Binance is considered a safe exchange that allows
                                        user account protection via the use of Two Authentication.</p>
                                    <a href="#!" class="btn btn-soft-info">Connect Wallet</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                        ...
                        <div class="col-lg-8">
                            <div class="text-center mb-5">
                                ...
                                <ul class="nav nav-pills filter-btns justify-content-center" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button" data-filter="artwork">Artwork
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button" data-filter="music">Music
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button" data-filter="games">Games
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link fw-medium" type="button" data-filter="crypto-card">
                                            Crypto Card
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                        ...
                        <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Creative
                        ...
                        <div class="col-lg-4 product-item music crypto-card games">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">The
                                            Chirstoper</a></h5>
                        ...
                        <div class="col-lg-4 product-item artwork music games">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Evolved
                                            Reality</a></h5>
                        ...
                        <div class="col-lg-4 product-item crypto-card 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Abstract
                                            Face Painting</a></h5>
                        ...
                        <div class="col-lg-4 product-item games music 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Long-tailed
                                            Macaque</a></h5>
                        ...
                        <div class="col-lg-4 product-item artwork music crypto-card">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="link-dark">Robotic
                                            Body Art</a></h5>
                                    <p class="text-muted fs-14 mb-0">Artwork</p>
                                </div>
                                <div class="card-footer border-top border-top-dashed">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">Create a collection in Opensea and give it a proper
                                        art.</p>
                                    <a href="#!" class="link-primary fs-14">Read More <i
                                            class="ri-arrow-right-line align-bottom"></i></a>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Artwork <span
                                                            class="badge badge-soft-secondary">206</span></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Crypto Card <span
                                                            class="badge badge-soft-secondary">743</span></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Music <span
                                                            class="badge badge-soft-secondary">679</span></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Games <span
                                                            class="badge badge-soft-secondary">341</span></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-0 fs-15"><a href="#!" class="link-dark">Photography <span
                                                            class="badge badge-soft-secondary">1452</span></a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <a href="apps-nft-explore" class="btn btn-secondary">View All <i
                                        class="ri-arrow-right-line align-bottom"></i></a>
                            </div>
                        </div>
                    </div><!-- end row -->
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="bookmark-icon">
                                            <button type="button" class="btn btn-icon active" data-bs-toggle="button"
                                                    aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Patterns
                                                arts &amp; culture</a></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Evolved
                                                Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Long-tailed
                                                macaque</a></h6>
                                    </div>
                                </div>
                            </div>
