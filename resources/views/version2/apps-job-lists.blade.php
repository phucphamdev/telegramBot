    ...
    <div class="row">
        ...
        <div class="col-xxl-3">
            <div class="card job-list-view-card overflow-hidden" id="job-overview">
                <img src="{{URL::asset('assets/images/small/img-10.jpg')}}" alt="" id="cover-img"
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted view-desc">A UI/UX designer's job is to create user-friendly interfaces
                            that enable users to understand how to use complex technical products. If you're passionate
                            about the latest technology trends and devices, you'll find great fulfillment in being
                            involved in the design process for the next hot gadget.</p>
                    ...
                    <div class="mt-4">
                        ...
                        <div>
                            <div id="simple_dount_chart"
                                 data-colors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-danger"]'
