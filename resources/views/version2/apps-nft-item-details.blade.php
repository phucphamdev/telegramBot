                ...
                <div class="col-lg-4">
                    <div class="sticky-side-div">
                        <div class="card ribbon-box border shadow-none right">
                            <div class="ribbon-two ribbon-two-danger"><span><i class="ri-fire-fill align-bottom"></i> Hot</span>
                            </div>
                    ...
                    <div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="p-2 border border-dashed rounded text-center">
                                    <div>
                                        ...
                                        <h5 class="fs-17 text-success mb-0"><i class="mdi mdi-ethereum me-1"></i> 83.06
                                            ETH</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-4 text-muted">
                            ...
                            <p>Cultural patterns are the similar behaviors within similar situations we witness due to
                                ...
                                "pattern" is: an arrangement of repeated or corresponding parts, decorative motifs,
                                etc.</p>
                        </div>
                                ...
                                <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab"
                                           href="#nav-speci" role="tab" aria-controls="nav-speci" aria-selected="true">Place
                                            Bids</a>
                                    </li>
                                    <li class="nav-item">
