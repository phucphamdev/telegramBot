...
@section('content')
            ...
            <div class="card bg-primary" style="background-image: url('assets/images/nft/bg-pattern.png');">
                <div class="card-body p-4">
                    ...
                    <p class="text-white-75 mb-3">Take advantage of the first text-based NFT. Select a text or write
                        your own and let it live forever on the Ethereum blockchain you or future owners can add text to
                        an existing ChainText token..</p>
            ...
            <div class="card overflow-hidden shadow-none">
                <div class="card-body bg-soft-success text-success fw-semibold d-flex">
                    <marquee class="fs-14">
                        ...
                        Every NFT is unique in it's creative design and cannot be duplicated, making them limited and
                        rare. NFTs get their value because the transaction proves ownership of the art.
                    </marquee>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        ...
                        <div class="place-bid-btn">
                            <a href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i> Place
                                Bid</a>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Patterns Arts &
                                Culture</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a>
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a>
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a>
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-15 mb-0"><a href="apps-nft-item-details" class="link-dark">Creative Filtered
                                Portrait</a></h6>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Trendy Fashion
                            Portraits</a></h5>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-15"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a>
                    </h5>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-03.jpg')}}" alt="" class="card-img-top object-cover"
                     height="120">
        ...
        <div class="col">
            <div class="card">
                <img src="https://img.themesbrand.com/velzon/images/img-5.gif" alt="" class="card-img-top object-cover"
                     height="120">
                <div class="card-body text-center">
                    <img src="{{URL::asset('assets/images/nft/img-04.jpg')}}" alt=""
                         class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-01.jpg')}}" alt="" class="card-img-top object-cover"
                     height="120">
                <div class="card-body text-center">
                    <img src="{{URL::asset('assets/images/nft/img-06.jpg')}}" alt=""
                         class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-05.jpg')}}" alt="" class="card-img-top object-cover"
                     height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                         class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{URL::asset('assets/images/nft/img-02.jpg')}}" alt="" class="card-img-top object-cover"
                     height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                         class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
