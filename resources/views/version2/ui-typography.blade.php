            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>text-decoration-underline</code>,
                        <code>text-decoration-line-through</code>, or <code>text-decoration-none</code> class to
                        decorate
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="bg-light clearfix p-3">
                            <button type="button" class="btn btn-primary float-start">Example Button floated left
                            </button>
                            <button type="button" class="btn btn-success float-end">Example Button floated right
                            </button>
                        </div>
                    </div>
