                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <p class="text-muted mb-4">Use <code>data-slider-color="secondary"</code> attribute to
                                    set
                    ...
                    <div class="row mt-4">
                        <div class="col-xl-4 col-lg-6">
                            <div class="mt-4">
                                ...
                                <p class="text-muted mb-4">Use <code>data-slider-color="dark"</code> attribute to set
                                    dark
                                    color scheme.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <p class="text-muted mb-4">Use <code>data-slider-size="md"</code> attribute to set
                                    medium
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <p class="text-muted mb-4">Use <code>data-slider-style="line"</code> attribute to set
                                    line
                                    rangeslider.</p>
