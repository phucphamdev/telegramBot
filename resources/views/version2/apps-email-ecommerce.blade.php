...
@section('title')
    @lang('translation.Invoice Action')
@endsection
@section('css')
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <table style="width:100%;">
                                                        ...
                                                        <tr style="text-align: left;">
                                                            <th style="padding: 5px;">
                                                                <p style="color: #878a99; font-size: 13px; margin-bottom: 2px; font-weight: 400;">
                                                                    Order Number</p>
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 12px;"
                                                    valign="top">
                                                    <h6 style="font-family: 'Roboto', sans-serif; font-size: 15px; text-decoration-line: underline;margin-bottom: 15px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    ...
                                                    valign="top">
                                                    <h3 style="font-family: 'Roboto', sans-serif; margin-bottom: 18px; text-align: center;line-height: 1.5;">
                                ...
                                <tr style="font-family: 'Roboto', sans-serif; font-size: 14px; margin: 0;">
                                    <td class="content-wrap"
                                        ...
                                        <div
                                            ...
                                            <h6 style="font-family: 'Roboto', sans-serif;margin: 0; font-size: 15px;color: #fff;text-transform: uppercase;">
                                        ...
                                        <div style="padding: 20px;box-sizing: border-box; text-align: center;">
                                            <h5 style="font-family: 'Roboto', sans-serif;margin-bottom: 10px;font-weight: 500;">
                                            ...
                                            <p style="font-size: 14px;color: #98a6ad;border-bottom: 1px solid #e9ebec;padding-bottom: 18px;">
                                                We'd love to hear how you and your pet enjoyed these products. Please
                                                leave a reviews so we can share it with other pet parents just like
                                                you.</p>
                                            ...
                                            <table style="width:100%;font-family: 'Roboto', sans-serif;">
                                                ...
                                                <tr style="text-align: left;">
                                                    ...
                                                    <th style="padding: 5px;">
                                                        <h6 style="font-family: 'Roboto', sans-serif; font-size: 14px; margin-bottom: 2px; font-weight: 500;">
                                                            350 ml Glass Grocery Container</h6>
                                                        <p style="color: #878a99; font-weight: 400;margin-bottom: 5px;line-height: 1.5;font-size: 12px;">
                                                            Category : Grocery</p>
                                                        <a href="#" itemprop="url"
                                        ...
                                        <div
                                            ...
                                            <h6 style="font-family: 'Roboto', sans-serif;margin: 0; font-size: 15px;text-transform: uppercase;color: #f06548;">
                                                Call us 24/7 at 1-2345-678-9123</h6>
                                        </div>
                                        <div style="padding: 20px;box-sizing: border-box; text-align: center;">
                                            <p style="font-family: 'Roboto', sans-serif;margin-bottom: 0px;font-weight: 500;color: #98a6ad;">
