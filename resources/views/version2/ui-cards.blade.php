                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-0">A business consulting agency is involved in the
                                planning,
                                implementation, and education of businesses. Miss told ham dull knew see she spot near
                                can.
                ...
                <div class="card-body collapse show" id="collapseexample1">
                    ...
                    <div class="d-flex mt-2">
                        ...
                        <div class="flex-grow-1 ms-2 text-muted">
                            ...
                            They
                            highly encourage that you use different fonts in one design, but do not over-exaggerate and
                            go
                            overboard.
                        </div>
                    </div>
                        ...
                        <div class="card-img-overlay p-0 d-flex flex-column">
                            ...
                            <div class="card-body">
                                <p class="card-text text-white mb-2">Each design is a new, unique piece of art birthed
                                    into
                                    this world, and while you have the opportunity to be creative and make your
                                    unpleasant
                                    for the reader. </p>
                                <p class="card-text">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted"> Exercitation +1 labore velit, blog sartorial PBR leggings
                                next
                                level wes anderson artisan four loko farm-to-table craft beer twee. commodo enim craft
                                beer
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text text-muted"> Exercitation +1 labore velit, blog sartorial PBR leggings
                                next
                                level wes anderson artisan four loko farm-to-table craft beer twee. ommodo enim craft
                                beer
                                mlkshk aliquip jean shorts ullamco.</p>
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted mb-0">For that very reason, I went on a quest and
                                        spoke
                                        to many different professional graphic designers and asked them what graphic
                                        design
                                        tips they live.</p>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="d-flex position-relative">
                                ...
                                <div>
                                    ...
                                    <p>This is some placeholder content for the custom component. It is intended to
                                        mimic
                                        what some real-world content would look like, and we're using it here to give
                                        the
