<!--begin::Table-->
<table class="table align-middle gs-0 gy-4" id="historyzalopay">
	<!--begin::Table head-->
	<thead>
	</thead>
	<!--end::Table head-->
...
<div class="modal fade" id="kt_modalhistoryzalopay" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<!--begin::Modal content-->
		<div class="modal-content">
			<!--begin::Form-->
			<form class="form" id="historyzalopay_form" method="POST" action="{{ route('historyzalopay.update') }}" >
				@csrf
				...
				<div class="modal-footer flex-center">
					...
					<!--end::Button-->
					<!--begin::Button-->
					<button type="submit" id="historyzalopay_submit"  class="btn btn-primary">
...
@section('scripts')
	<script type="text/javascript">
		...
		(function ($) {
			"use strict";
			$('#historyzalopay').DataTable({
				ordering: true,
				processing: true,
				serverSide: true,
				ajax: '{{ route('historyzalopay.datatables') }}',
				columns: [
					{data: 'id', name: 'id'},
