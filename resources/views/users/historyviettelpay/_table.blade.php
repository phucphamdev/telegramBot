<!--begin::Table-->
<table class="table align-middle gs-0 gy-4" id="historyviettelpay">
	<!--begin::Table head-->
	<thead>
	</thead>
	<!--end::Table head-->
...
<div class="modal fade" id="kt_modalhistoryviettelpay" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<!--begin::Modal content-->
		<div class="modal-content">
			<!--begin::Form-->
			<form class="form" id="historyviettelpay_form" method="POST" action="{{ route('historyviettelpay.update') }}" >
				@csrf
				...
				<div class="modal-footer flex-center">
					...
					<!--end::Button-->
					<!--begin::Button-->
					<button type="submit" id="historyviettelpay_submit"  class="btn btn-primary">
...
@section('scripts')
	<script type="text/javascript">
		(function ($) {
			"use strict";
			$('#historyviettelpay').DataTable({
				ordering: true,
				processing: true,
				serverSide: true,
				ajax: '{{ route('historyviettelpay.datatables') }}',
				columns: [
					{data: 'id', name: 'id'},
