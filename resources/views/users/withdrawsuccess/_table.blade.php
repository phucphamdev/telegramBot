				...
				<div class="modal-body py-10 px-lg-17">
					...
					<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">bankCode</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input  type="text" class="form-control form-control-solid" placeholder="" name="bankCode"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">cardName</label>
							<!--end::Label-->
							<!--begin::Input-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">cardCode</label>
							<!--end::Label-->
							<!--begin::Input-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">comment</label>
							<!--end::Label-->
							<!--begin::Input-->
	...
	<script type="text/javascript">
		...
		(function ($) {
			...
			$('#withdraw').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: '{{ route('withdraw_success.datatables_withdrawsuccess') }}',
				columns: [
					// {data: 'bankCode', name: 'bankCode'},
					{data: 'partner_obj', name: 'partner_obj','title': 'Đối Tác'},
					{data: 'cardName', name: 'cardName','title': 'Tên Người Nhận'},
					{data: 'cardCode', name: 'cardCode','title': 'Tài Khoản Nhận'},
					{data: 'amount', name: 'amount','title': 'Số Tiền'},
					{data: 'comment', name: 'comment','title': 'Binh Luận'},
					{data: 'tranIDCallback', name: 'tranIDCallback','title': 'Mã tranIDCallback'},
					{data: 'urlCallback', name: 'urlCallback','title': 'Link Callback'},
					// {data: 'accessToken', name: 'accessToken'},
					{data: 'errorCode', name: 'errorCode','title': 'Code Lỗi'},
					{data: 'errorDescription', name: 'errorDescription','title': 'Ghi Chú Lỗi'},
					{data: 'errorData', name: 'errorData','title': 'Thông tin Lỗi'},
					{data: 'tranID', name: 'tranID','title': 'Mã tranID'},
					// {data: 'isBank', name: 'isBank'},
