<div class="block_content">
    <h2 class="title">
        <a>6. Lấy Ngân Hàng Đang Hoạt Động</a>
    </h2>
    <div class="byline">
        by <a>Administrator</a>
    </div>
    <p class="mb-0 font-weight-bold">Lấy Ngân Hàng Đang Hoạt Động:</p>
    ...
    <p class="mb-0">+ Key của bạn: <span
                class="text-info">Key</span></p>
    <p class="mb-2"><span class="text-primary">API: </span> <span
                class="text-info">https://kpaypro.vip/api/partnersbanklist/check</span>
    </p>
