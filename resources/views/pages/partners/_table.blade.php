<!--begin::Table-->
<table class="table align-middle gs-0 gy-4" id="partners">
	<!--begin::Table head-->
	<thead>
	<tr>
		<td >first_name</td>
...
<div class="modal fade" id="kt_modalpartners" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<!--begin::Modal content-->
		<div class="modal-content">
			<!--begin::Form-->
			<form class="form" id="partners_form" name="partners_form" method="POST"
				...
				<div class="modal-body py-10 px-lg-17">
					...
					<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">ck_momo</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid" placeholder="" name="ck_momo"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">ck_vtpay</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid" placeholder="" name="ck_vtpay"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">ck_bank</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid" placeholder="" name="ck_bank"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">ck_zalo</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid" placeholder="" name="ck_zalo"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">Số Dư</label>
							<!--end::Label-->
							<!--begin::Input-->
							<input class="form-control form-control-solid" placeholder="" name="so_du"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->

						<div class="d-flex flex-column mb-5 fv-row">
							<label class="required fs-5 fw-semibold mb-2">Cộng / Trừ Tiền</label>
							<div class="col-xl-9">
								<div class="form-check form-switch form-check-custom form-check-solid">
									<select aria-label="label for the select" class="form-select form-select-solid"
											data-control="select2" name="type_add"
											data-kt-ecommerce-order-filter="type_add" id="type_add">
						...
						<div class="d-flex flex-column mb-5 fv-row">
							<!--begin::Label-->
							<label class="required fs-5 fw-semibold mb-2">số Tiền: </label>
							<!--end::Label-->
							<!--begin::Input-->
							<input type="number" class="form-control form-control-solid" name="money"/>
							<!--end::Input-->
						</div>
						<!--end::Input group-->
...
<div class="pt-6">
	...
	<div class="card card-body pt-6">
		...
		<div class="card card-flush">
			<div class="card-body">
				<form id="partners_create" name="partners_create" method="post" class="form"
					...
					<div class="fv-row mb-10">
						...
						<input class="form-control form-control-solid" placeholder="123456" value="123456"
	...
	<script type="text/javascript">
		...
		$("#partners_form").submit(function (e) {
			...
			let formData = {
				...
				key: $("[name='key']").val(),
				ck_momo: $("[name='ck_momo']").val(),
				ck_vtpay: $("[name='ck_vtpay']").val(),
				ck_bank: $("[name='ck_bank']").val(),
				ck_zalo: $("[name='ck_zalo']").val(),
				so_du: $("[name='so_du']").val(),
				access_token: $("[name='access_token']").val(),
				ip: $("[name='ip']").val(),
				money: $("[name='money']").val(),
				password: $("[name='password']").val(),
				type: $("#type option:selected").val(),
				type_add: $("#type_add option:selected").val(),
			};
		...
		$("#partners_create").submit(function (e) {
		...
		(function ($) {
			...
			$('#partners').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: '{{ route('partners.datatables') }}',
				columns: [
					// {data: 'id', name: 'id'},
					// {data: 'UUID', name: 'UUID'},
					...
					{data: 'ck_momo', name: 'ck_momo'},
					{data: 'ck_vtpay', name: 'ck_vtpay'},
					{data: 'ck_bank', name: 'ck_bank'},
					{data: 'ck_zalo', name: 'ck_zalo'},
					{data: 'so_du', name: 'so_du'},
