{{--<!--begin::Table-->--}}
{{--<table class="table align-middle gs-0 gy-4" id="apimanage">--}}
{{--	<!--begin::Table head-->--}}
{{--	<thead>--}}
{{--	</thead>--}}
{{--	<!--end::Table head-->--}}
...
{{--<div class="modal fade" id="kt_modalapimanage" tabindex="-1" aria-hidden="true">--}}
{{--	<!--begin::Modal dialog-->--}}
{{--	<div class="modal-dialog modal-dialog-centered mw-650px">--}}
{{--		<!--begin::Modal content-->--}}
{{--		<div class="modal-content">--}}
{{--			<!--begin::Form-->--}}
{{--			<form class="form" id="apimanage_form" method="POST" action="{{ route('apimanage.update') }}" >--}}
{{--				@csrf--}}
...
{{--					<!--end::Button-->--}}
{{--					<!--begin::Button-->--}}
{{--					<button type="submit" id="apimanage_submit"  class="btn btn-primary">--}}
...
{{--			$("#apimanage_form").submit(function (e) {--}}
...
{{--				processing: true,--}}
{{--				serverSide: true,--}}
{{--				ajax: '{{ route('apimanage.datatables') }}',--}}
{{--				columns: [--}}
{{--					{data: 'id', name: 'id'},--}}
