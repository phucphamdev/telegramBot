<!--begin::Table-->
<table class="table align-middle gs-0 gy-4" id="partnerscustomer">
	<!--begin::Table head-->
	<thead>
	</thead>
	<!--end::Table head-->
...
<div class="modal fade" id="kt_modalpartnerscustomer" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<!--begin::Modal content-->
		<div class="modal-content">
			<!--begin::Form-->
			<form class="form" id="partnerscustomer_form" name="partnerscustomer_form" method="POST"
				  action="{{ route('partnerscustomer.update') }}">
				@csrf
				<!--begin::Modal header-->
							...
							<div class="col-xl-9">
								<div class="form-check form-switch form-check-custom form-check-solid">
									...
									<select aria-label="label for the select" class="form-select form-select-solid"
										...
										<option value="3" selected>Khách Khàng Của Đói Tác</option>
									</select>
									<!--end::Select2-->
								</div>
							</div>
				...
				<div class="modal-footer flex-center">
					<!--begin::Button-->
					<button type="submit" id="historybank_submit" class="btn btn-primary">
...
<div class="pt-6">
	...
	<div class="card card-body pt-6">
		...
		<div class="card card-flush">
			<div class="card-body">
				<form id="partnerscustomer_create" name="partnerscustomer_create" method="post" class="form"
					  action="{{ route('partnerscustomer.store') }}">
					@csrf
...
@section('scripts')
	...
	<script type="text/javascript">
		...
		function getDetailPartnersCustomer(event, element) {
		...
		function getDeletePartnersCustomer(event, element) {
			Swal.fire({
				title: "Are you sure?",
		...
		$("#partnerscustomer_form").submit(function (e) {
		...
		$("#partnerscustomer_create").submit(function (e) {
		...
		(function ($) {
			...
			$('#partnerscustomer').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: '{{ route('partnerscustomer.datatables') }}',
				columns: [
					// {data: 'id', name: 'id'},
					// {data: 'UUID', name: 'UUID'},
