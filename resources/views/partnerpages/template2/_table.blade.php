        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container flex-column-fluid">
                ...
                <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10"
                     style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url({{ asset(theme()->getMediaUrlPath() . 'illustrations/sketchy-1/4.png') }})">
                    <!--begin::Card header-->
                        ...
                        <form class="form" id="kt_file_manager_settings">
                            ...
                            <div class="fv-row row mb-15">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="text-muted fs-7">For more info on moment() date formats,
                                        please
                                ...
                                <div class="col-md-9">
                                    <!--begin::Input-->
                                    <select name="dateformat" aria-label="Select a date format"
                            ...
                            <div class="fv-row row mb-15">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" name="autotimezone"
                                               type="checkbox" value="" id="autotimezone"/>
                                        <label class="form-check-label" for="autotimezone">GMT
                                            +10:00</label>
                                    </div>
                                    <!--begin::Switch-->
                                </div>
                            ...
                            <div class="fv-row row mb-15">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="text-muted fs-7">Default file compression type when
                                        downloading folders
                                    </div>
                                    <!--end::Label-->
                                </div>
                                ...
                                <div class="col-md-9">
                                    <!--begin::Input-->
                                    <select name="compression" aria-label="Select a Compressions type"
                            ...
                            <div class="fv-row row mb-15">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="d-flex">
                                        <!--begin::Switch-->
                                        <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                            <input class="form-check-input h-30px w-50px" name="org_read"
                                                   type="checkbox" value="" id="org_read"
                                                   checked="checked"/>
                                        ...
                                        <!--begin::Switch-->
                                        <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                            <input class="form-check-input h-30px w-50px" name="org_write"
                                                   type="checkbox" value="" id="org_write"
                                                   checked="checked"/>
                                    ...
                                    <div class="d-flex">
                                        <!--begin::Switch-->
                                        <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                            <input class="form-check-input h-30px w-50px" name="public_read"
                                                   type="checkbox" value="" id="public_read"
                                                   checked="checked"/>
                                        ...
                                        <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                            <input class="form-check-input h-30px w-50px"
                                                   name="public_write" type="checkbox" value=""
                                                   id="public_write"/>
